	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			createRequest.setTemplateBody(convertStreamToString(
				CloudFormationSample.class.getResourceAsStream("cloudformation/CloudFormationSample.template")));
			...
			System.out.println(
				"Stack creation completed, the stack " + stackName + " completed with " + waitForCompletion(stackbuilder,
					stackName));
			...
			System.out
				.format("Looking up resource name %1$s from stack %2$s\n", logicalNameResourceRequest.getLogicalResourceId(),
					logicalNameResourceRequest.getStackName());
