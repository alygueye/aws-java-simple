...
public final class AmazonKinesisApplicationSample {
	...
	public static void main(String[] args) throws Exception {
		...
		KinesisClientLibConfiguration kinesisClientLibConfiguration = new KinesisClientLibConfiguration(SAMPLE_APPLICATION_NAME,
